...
export const uzUZ: LocalizationResource = {
	...
	signIn: {
		start: {
			...
			actionLink__use_email_username: 'Pochta yoki foydalanuvchi nomini ishlatish',
		},
		password: {
		...
		resetPassword: {
			...
			successMessage: "Sizning parolingiz muvaffaqiyatli o'zgartirildi. Kirish amalga oshirilyapti, kuting.",
		},
		resetPasswordMfa: {
			detailsLabel: "Parolni tiklashdan oldin shaxsiy ma'lumotlaringizni tasdiqlang",
		},
		emailCode: {
		...
		emailLink: {
			...
			verifiedSwitchTab: {
				...
				subtitleNewTab: "Davom etish uchun faqat boshqa ochilgan varag'ga qayting",
			},
			loading: {
				title: 'Kirish amalga oshirilyapti...',
				subtitle: "Siz tez orada yo'naltirilasiz",
		...
		totpMfa: {
			...
			subtitle: '',
			formTitle: 'Tasdiqlash kodi',
			// formSubtitle: "O'zingizning tasdiqlash apparatingizdan olingan tasdiqlash kodini kiriting",
		},
		backupCodeMfa: {
		...
		noAvailableMethods: {
			...
			message: "Kirish mumkin emas. Tasdiqlash uchun mavjud barcha faktorlar yo'q.",
		},
	},
	userProfile: {
		...
		profilePage: {
			...
			fileDropAreaHint: 'JPG, PNG, GIF yoki WEBP formatidagi rasmni 10 MB dan kichikroq yuklang',
		...
		emailAddressPage: {
			...
			emailCode: {
				...
				resendButton: 'Kodni qayta yuborish',
				successMessage: "{{identifier}} elektron pochta manzili sizning hisobingizga qo'shildi.",
			},
			emailLink: {
				formHint: 'Ushbu elektron pochta manziliga tasdiq havolasi yuboriladi.',
				formTitle: 'Tasdiq havolasi',
				formSubtitle: '{{identifier}} ga yuborilgan tasdiq havolasini bosib oling',
				resendButton: 'Havolani qayta yuborish',
				successMessage: "{{identifier}} elektron pochta manzili sizning hisobingizga qo'shildi.",
			},
			removeResource: {
				...
				messageLine2: "Bu elektron pochta manzilidan foydalanib hisobga kirish imkoni yo'q.",
				successMessage: '{{emailAddress}} sizning hisobingizdan olib tashlandi.',
			},
		},
		phoneNumberPage: {
			...
			// infoText__secondary: "Xabarlar va ma'lumotlar uchun tariflar qo'llanilishi mumkin.",
			removeResource: {
				title: 'Telefon raqamini olib tashlash',
				messageLine1: '{{identifier}} ushbu hisobdan olib tashlanadi.',
				messageLine2: "Bu telefon raqamidan foydalanib hisobga kirish imkoni yo'q.",
		...
		connectedAccountPage: {
			...
			removeResource: {
				...
				messageLine1: '{{identifier}} ushbu hisobdan olib tashlanadi.',
				messageLine2: "Ushbu bog'langan hisobni ko'rsatadigan har qanday funksiya ishlamaydi.",
				successMessage: '{{connectedAccount}} sizning hisobingizdan olib tashlandi.',
			},
		},

		web3WalletPage: {
			title: "Web3 xususiy qog'ozni qo'shish",
			subtitle__availableWallets: "Hisobingizga bog'lanish uchun web3 xususiy qog'ozni tanlang.",
			...
			removeResource: {
				...
				messageLine1: '{{identifier}} ushbu hisobdan olib tashlanadi.',
				messageLine2: "Siz ushbu web3 xususiy qog'ozi bilan kirish imkoniyatiga ega bo'lmaysiz.",
		...
		passwordPage: {
			...
			// sessionsSignedOutSuccessMessage: 'Barcha boshqa qurilmalar tizimdan chiqarildi.',
		},
		mfaPage: {
		...
		mfaTOTPPage: {
			...
			removeResource: {
				...
				messageLine1: 'Bu autentifikatsiya ilovasidan olingan tasdiq kodi tizimga kirishda talab qilmaydi.',
				messageLine2: "Sizning hisobingiz kamroq himoyalangan bo'ladi. Davom etmoqchimisiz?",
		...
		mfaPhoneCodePage: {
			...
			subtitle__availablePhoneNumbers: 'SMS-kod bilan ikki bosqichli tekshirish uchun telefon raqamini tanlang.',
			subtitle__unavailablePhoneNumbers: 'SMS-kod bilan ikki bosqichli tekshirish uchun mavjud emas telefon raqamlari.',
			// successMessage:
			...
			removeResource: {
				...
				messageLine2: "Sizning hisobingiz kamroq himoyalangan bo'ladi. Davom etmoqchimisiz?",
				successMessage: "{{mfaPhoneCode}} uchun SMS-kod bilan ikki bosqichli tekshirish o'chirildi.",
			},
		},
		backupCodePage: {
			...
			successSubtitle: "Agar siz avtentifikatsiya qurilmangizga kirishni yo'qotib, ularni ishlatishingiz mumkin bo'ladi.",
			successMessage:
	...
	organizationProfile: {
		start: {
			...
			// headerSubtitle__members: "Tashkilot a'zolarini ko'rib boshlash va boshqarish",
		...
		profilePage: {
			...
			dangerSection: {
				...
				deleteOrganization: {
					...
					messageLine1: "Haqiqatan ham ushbu tashkilotni o'chirishni xohlaysizmi?",
					messageLine2: 'Bu amalni bekor qilish mumkin emas.',
					actionDescription: "Davom etish uchun, quyidagi maydonni to'ldiring: {{organizationName}}.",
		...
		verifyDomainPage: {
			...
			subtitle: '{{domainName}} domeni elektron pochta orqali tasdiqlanishi kerak.',
			subtitleVerificationCodeScreen:
				'Tasdiqlash kodi {{emailAddress}} elektron pochtasiga yuborildi. Davom etish uchun uni bu yerga kiriting.',
			formTitle: 'Tasdiqlash kodi',
			formSubtitle: 'Belgilangan elektron pochtaga yuborilgan tasdiqlash kodi kiriting',
			resendButton: 'Kod kelayotganmi? Qayta yuborish',
		},
		verifiedDomainPage: {
			subtitle: "{{domain}} domeni tasdiqlandi. Endi foydalanuvchilar uni qanday qilib tashkilotga qo'shilishini tanlang.",
			start: {
				headerTitle__enrollment: "Qo'shilish usullari",
				headerTitle__danger: 'Xavotir',
			},
			enrollmentTab: {
				subtitle: "Elektron pochta domeni bo'lgan foydalanuvchilar tashkilotga qanday usulda qo'shilishlari kerakligini tanlang.",
				...
				calloutInfoLabel: "Qo'shilish usulini o'zgartirish faqat yangi foydalanuvchilar uchun ta'sir ko'rsatadi.",
			...
			dangerTab: {
				...
				removeDomainSubtitle: 'Ushbu domenni tasdiqlanganlar sonidan olib tashlash',
				removeDomainActionLabel__remove: 'Domenni olib tashlash',
				calloutInfoLabel: "Domen olib tashlash foydalanuvchilarga ta'sir ko'rsatadi.",
			},
		},
		invitePage: {
	...
	unstable__errors: {
		...
		form_password_pwned: "Bu parol hacklangan va ishlatilishi mumkin emas, boshqa parolni sinab ko'ring.",
		form_password_validation_failed: "Noto'g'ri parol",
		form_password_not_strong_enough: 'Sizning parolingiz yetarli darajada xavfsiz emas.',
		...
		zxcvbn: {
			...
			warnings: {
				...
				extendedRepeat: '"abcabcabc" kabi takrorlanuvchi belgilar oson aniqlanadi.',
				...
				userInputs: "Shaxsiy ma'lumot yoki sahifangizga oid ma'lumot bo'lishi mumkin emas.",
				pwned: "Bu parol internetda ma'lumotlar olinishi natijasida ifodalangan.",
			},
			suggestions: {
				l33t: `"@", "a" o'rniga ma'lumotlar kiritilgan "a" kabi kutilmagan belgilar qo'shishdan qoching.`,
				reverseWords: "Ko'p ishlatiladigan so'zlarni teskari kiritishdan qoching.",
				allUppercase: "Ba'zi, ammo barcha harflarni katta qiling.",
				capitalization: "Faqat birinchi harfini katta qiling, yangi qoidalar qo'shishdan qoching.",
				...
				longerKeyboardPattern: "Uzoq klaviatura kombinatsiyalarini ishlating va bir nechta marta yo'nalishni o'zgartiring.",
				anotherWord: "Ko'p ishlatilmaydigan so'zlar qo'shing.",
				useWords: "Bir nechta so'zlar ishlating, lekin umumiy so'zlaridan bo'linishingizdan qoching.",
				noNeed: 'Belgilar, raqamlar yoki katta harflar ishlatmasdan ham xavfsiz parollar yarata olasiz.',
				pwned: "Agar bu parolingizni boshqa joyda ishlatasiz, uni o'zgartirishingiz kerak.",
			},
		},
	},

	dates: {
		previous6Days: "O'tgan {{ date | weekday('ru-RU','long') }} {{ date | timeString('ru-RU') }} da",
		lastDay: "Kecha {{ date | timeString('ru-RU') }} da",
		sameDay: "Bugun {{ date | timeString('ru-RU') }} da",
		nextDay: "Ertaga {{ date | timeString('ru-RU') }} da",
		next6Days: "{{ date | weekday('ru-RU','long') }} {{ date | timeString('ru-RU') }} da",
